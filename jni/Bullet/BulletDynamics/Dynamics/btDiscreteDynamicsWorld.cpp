...
{
	BT_PROFILE("btDiscreteDynamicsWorld::synchronizeMotionStates()");
...
int	btDiscreteDynamicsWorld::stepSimulation( btScalar timeStep,int maxSubSteps, btScalar fixedTimeStep)
{
	...
	BT_PROFILE("btDiscreteDynamicsWorld::stepSimulation()");
...
void	btDiscreteDynamicsWorld::internalSingleStepSimulation(btScalar timeStep)
{
	...
	BT_PROFILE("btDiscreteDynamicsWorld::internalSingleStepSimulation()");
...
{
	BT_PROFILE("btDiscreteDynamicsWorld::updateActions()");
...
{
	BT_PROFILE("btDiscreteDynamicsWorld::updateActivationState()");
...
{
	BT_PROFILE("btDiscreteDynamicsWorld::solveConstraints()");
...
{
	BT_PROFILE("btDiscreteDynamicsWorld::calculateSimulationIslands()");
...
{
	BT_PROFILE("btDiscreteDynamicsWorld::createPredictiveContacts()");
...
{
	BT_PROFILE("btDiscreteDynamicsWorld::integrateTransforms()");
	btTransform predictedTrans;
	for ( int i=0;i<m_nonStaticRigidBodies.size();i++)
	{
		btRigidBody* body = m_nonStaticRigidBodies[i];
...
{
	BT_PROFILE("btDiscreteDynamicsWorld::predictUnconstraintMotion()");
	for ( int i=0;i<m_nonStaticRigidBodies.size();i++)
	{
		btRigidBody* body = m_nonStaticRigidBodies[i];
		if (!body->isStaticOrKinematicObject())
